...
public class ChoiceManager : MonoBehaviour
{
    ...
    private Image[] selectBoxes;             // 所有选中框
    ...
    void Start()
    {
        ...
        selectBoxes = new Image[childCount];
    ...
    public void SelectBtn(Button _btn)
    {
        ...
        {
            selectBtn.transform.Find("selectBoxes").gameObject.SetActive(false);        // 把旧的子物体关闭
        }
        selectBtn = _btn;       // 记录当前选中的按钮
        selectBtn.transform.Find("selectBoxes").gameObject.SetActive(true);     // 显示当前选中的框
        // 激活“确定”按钮
    ...
    void OnOptionSelected(int index)
    {
        ...
        {
            selectBoxes[i].gameObject.SetActive(false);
        }
    ...
    void OnConfirm()
    {
        if (selectedIndex != -1)
        {
            ...
            // 跳转到下一场景（请换成你的场景名）
            SceneManager.LoadScene("DummyArchives");
        }
    }
}
